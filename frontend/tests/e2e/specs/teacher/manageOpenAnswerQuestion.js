describe('Manage Open Answer Questions Walk-through', () => {
    function validateQuestion(
      ...
      cy.get('[data-cy="showQuestionDialog"]')
        ...
        .within($ls => {
          ...
          //cy.get('[name="open-answer-view-correct"]').should('contain', correctAnswer);
        });
    }
    ...
    before(() => {
      console.log("debug: will do the before function");
      ...
      console.log("debug: did before function");
    });
    after(() => {
        cy.cleanOpenAnswerQuestionsByName('Cypress Question Example');
    });
    ...
    it('Can update correct answer (with button)', function() {
        cy.route('PUT', '/questions/*').as('updateQuestion');
        ...
        cy.get('[data-cy="createOrEditQuestionDialog"]')
          ...
          .within($list => {
            ...
            cy.get('[data-cy="QuestionCorrectAnswer"]')
              .clear({ force: true })
              .type('Cypress New Correct Answer For Question!', { force: true });
        ...
        validateQuestionFull(
          (title = 'Cypress Question Example - 01 - Edited'),
          (content = 'Cypress New Content For Question!'),
          (correctAnswer = 'Cypress New Correct Answer For Question!')
        );
      });
    ...
    it('Can duplicate question', function() {
      ...
      validateQuestionFull(
        ...
        'Cypress New Content For Question!',
        'Cypress New Correct Answer For Question!'
      );
    });
