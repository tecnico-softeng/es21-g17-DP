...
public class QuestionsXmlImport {
    ...
    private QuestionDetailsDto importItemCombinationQuestion(Element questionElement) {
        ...
        var items = new ArrayList<ItemCombinationItemDto>();
        for (Element spotElement : questionElement.getChild("itemCombinationItems").getChildren("itemCombinationItem")) {
            var item = new ItemCombinationItemDto();
            item.setSequence(Integer.valueOf(spotElement.getAttributeValue("sequence")));
            var options = new ArrayList<ItemCombinationOptionDto>();
            for (Element optionElement : spotElement.getChildren("itemCombinationOption")) {
                ...
                boolean none = Boolean.parseBoolean(optionElement.getAttributeValue("none"));
                ItemCombinationOptionDto optionDto = new ItemCombinationOptionDto();
                optionDto.setSequence(optionSequence);
                optionDto.setContent(optionContent);
                optionDto.setCorrect(correct);
                optionDto.setNone(none);
        ...
        questionDto.setItemCombinationItems(items);
        return questionDto;
    }
    ...
    private QuestionDetailsDto importMultipleChoiceQuestion(Element questionElement) {
        ...
        Boolean relevanceOfOptionsConsidered = Boolean.parseBoolean
                (questionElement.getAttributeValue("relevanceOfOptionsConsidered"));

        multipleChoiceQuestionDto.setRelevanceOfOptionsConsidered(relevanceOfOptionsConsidered);
    ...
    private QuestionDetailsDto importOpenAnswerQuestion(Element questionElement) {
        ...
        String correctAnswer = questionElement.getAttributeValue("correctAnswer");
