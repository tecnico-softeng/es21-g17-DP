...
public enum ErrorMessage {
    ...
    ONLY_ONE_OPTION_NONE_ALLOWED("Items must always have one and only one option with none flag set to true."),
    NONE_OPTION_IS_SET_CORRECT("The option with the flag none set to true is already the correct one"),
    ...
    AT_LEAST_ONE_ITEM_NEEDED("Questions need to have at least one item."),
    AT_LEAST_ONE_CORRECT_OPTION("Questions need to have at least one correct option."),
    ...
    OPTIONS_NEED_DIFFERENT_RELEVANCES("Options need to have different levels of relevance"),
    ...
    OPENANSWER_AT_LEAST_ONE_ANSWER_NEEDED("Cannot create an open answer question with no answers"),
    OPENANSWER_INVALID_CORRECT_ANSWER("Correct answer cannot be blank"),
    OPENANSWER_NOASWER("Cannot create an open answer fill-in question with no answer attributed");
