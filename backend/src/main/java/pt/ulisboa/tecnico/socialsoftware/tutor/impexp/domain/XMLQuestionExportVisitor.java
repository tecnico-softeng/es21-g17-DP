...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    public void visitQuestionDetails(MultipleChoiceQuestion question) {
        ...
        this.currentElement.setAttribute("relevanceOfOptionsConsidered", String.valueOf(question.isRelevanceOfOptionsConsidered()));
    ...
    public void visitQuestionDetails(OpenAnswerQuestion question) {
        ...
        this.currentElement.setAttribute("correctAnswer", question.getCorrectAnswerRepresentation() );
    }
    ...
    public void visitQuestionDetails(ItemCombinationQuestion question) {
        ...
        Element itemsElement = new Element("itemCombinationItems");
        this.currentElement.addContent(itemsElement);

        this.currentElement = itemsElement;
        question.visitItemCombinationItems(this);
    }

    @Override
    public void visitItemCombinationItem(ItemCombinationItem item) {
        Element itemElement = new Element("itemCombinationItem");

        itemElement.setAttribute("sequence", String.valueOf(item.getSequence()));
        itemElement.setAttribute("content", String.valueOf(item.getContent()));
        this.currentElement.addContent(itemElement);
        var oldElement = this.currentElement;
        this.currentElement = itemElement;

        item.visitOptions(this);
    ...
    public void visitItemCombinationOption(ItemCombinationOption option) {
        ...
        optionElement.setAttribute("content", option.getContent());
        optionElement.setAttribute("correct", String.valueOf(option.isCorrect()));
        optionElement.setAttribute("none", String.valueOf(option.isNone()));
