...
class SpockTest extends Specification {
    ...
    /** PRA */
    public static final String ANSWER_1_CONTENT = "Correct Answer 1 Content"
    public static final String ANSWER_2_CONTENT = "Correct Answer 2 Content"
    /** end PRA */
    ...
    @Autowired
    ItemCombinationItemRepository itemCombinationItemRepository

    @Autowired
    ItemCombinationOptionRepository itemCombinationOptionRepository
